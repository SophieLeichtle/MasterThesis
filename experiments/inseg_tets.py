...
from yolo_mask_utils import create_model, get_predictions, prepare_image, save_seg_image
...
def main():
    ...
    while step != max_steps:
        ...
        if action_generator.picture_flag == 1:
            ...
            save_seg_image("seg2.png", img_tensor, predictions, pred_masks, hyp, names)
