...
class ScanObjectTask(BaseTask):
    ...
    def __init__(self, env):
        super(ScanObjectTask, self).__init__(env)
    ...
    def get_termination(self, env, collision_links=[], action=None, info={}):
        ...
        """
        done, info = super(ScanObjectTask, self).get_termination(env, collision_links, action, info)
